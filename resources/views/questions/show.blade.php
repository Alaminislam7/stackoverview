                ...
                <div class="card-body">
                    ...
                    <div class="media">
                        <div class="d-flex flex-column vote-controls">
                            ...
                            <form id="up-vote-{{ $question->id }}" action="/questions/{{ $question->id }}/vote" method="POST" style="display:none;">
                                @csrf
                            ...
                            <form id="down-vote-{{ $question->id }}" action="/questions/{{ $question->id }}/vote" method="POST" style="display:none;">
                                @csrf
                                <input type="hidden" name="vote" value="-1">
                            </form>
